              ...
              <div class="col-sm-12">
                <table class="table table-striped table-border checkout-table">
                  <tbody>
                    ...
                    <tr>
                      <td class="hidden-xs"><a href="#"><img src="themes/images/products/large/ml.jpg"" alt="Mobile Legends 1"/></a></td>
                      <td>
                        <h5 class="product-title font-alt">Mobile Legends 1</h5>
                        <p>Skin: 14 | Rank: Master Emblem: Max | Hero: 25 Emote: 11 | Recall: 15</p>
                      </td>
                      <td class="hidden-xs">
                        <h5 class="product-title font-alt">Rp.222.000</h5>
                      </td>
                      <td>
            ...
            <div class="row">
              <div class="col-sm-3">
                <div class="form-group">
                  <input class="form-control" type="text" id="" name="" placeholder="Email"/>
                </div>
              </div>
              <div class="col-sm-3">
                <div class="form-group">
